	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain fc) throws IOException, ServletException {
		...
		if(isNotNeedAuthCheckUrl(servletPath, request)){
			if("/index".equals(servletPath) 
					|| "/fntshoppingcart/home/list".equals(servletPath) 
					|| "/common/checkunitystate".equals(servletPath) 
					|| "/common/loginAuth/login".equals(servletPath)
					|| "/fnthouse/upload".equals(servletPath)
					){
				//首页会话设置用户信息
